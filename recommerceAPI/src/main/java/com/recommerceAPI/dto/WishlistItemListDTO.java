...
package com.recommerceAPI.dto; // 패키지 선언, com.mallapi.dto 패키지에 속함을 나타냄
...
public class WishlistItemListDTO { // 쇼핑카트 아이템 리스트를 위한 DTO(Data Transfer Object) 클래스 선언

    private Long wino; // 카트 아이템 고유 번호
