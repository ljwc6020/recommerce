...
@Table(name = "tbl_sale_list_item", indexes = {
        @Index(name = "idx_sale_list_item_sale_list", columnList = "sale_list_id"), // 판매 목록 ID에 대한 인덱스
        @Index(name = "idx_sale_list_item_product", columnList = "product_id") // 판매된 상품 ID에 대한 인덱스
})
